...
def get_push_settings(chain):
    return {
        ...
        "push_x7r": {
            ...
            "threshold": 10000,
            "contract_type": "hub",
            "calculate_tokens": lambda contract: float(etherscan.get_token_balance(
        ...
        "push_x7105": {
            ...
            "threshold": 10000,
            "contract_type": "hub",
            "calculate_tokens": lambda _: etherscan.get_token_balance(ca.X7100_LIQ_HUB(chain), ca.X7105(chain), chain)
        },
    }