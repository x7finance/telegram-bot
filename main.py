...
if __name__ == "__main__":
    ...
    application.add_handler(CommandHandler(["constellations", "constellation", "quints", "x7100"], commands.constellations))
    ...
    application.add_handler(CallbackQueryHandler(callbacks.pushall, pattern=r"^push:(eco|treasury|x7r|x7dao|x710[1-5]):[a-z]+$"))
    application.add_handler(CallbackQueryHandler(callbacks.liquidate, pattern=r"^liquidate:\d+:[a-z]+$"))
